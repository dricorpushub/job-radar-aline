...
from core.config_aline import (
    KEYWORDS_ALINE,
    KEYWORDS_CARGO_FORTE_ALINE,
    KEYWORDS_CARGO_AMBIGUO_ALINE,
    QUALIFICADORES_ALINE,
    FERRAMENTAS_TITULO_ALINE,
    QUALIFICADORES_CARGO_ALINE,
    TERMOS_BLOQUEADOS_TITULO_ALINE,
    CIDADES_ALINE,
    MODALIDADES_ACEITAS_ALINE,
    MERCADOS_REMOTO_ACEITOS_ALINE,
    TERMOS_BUSCA_ALINE,
    TERMOS_PRIORITARIOS_ALINE,
    TERMOS_POR_CICLO_ALINE,
    LOCATIONS_LINKEDIN_ALINE,
    LOCATIONS_LINKEDIN_REMOTO_APENAS_ALINE,
    LOCATIONS_LINKEDIN_CIDADES_HIBRIDO_ALINE,
)
...
_REGRAS_ALINE = RegrasFiltro(
    keywords_forte=KEYWORDS_CARGO_FORTE_ALINE,
    keywords_ambiguo=KEYWORDS_CARGO_AMBIGUO_ALINE,
    qualificadores_dados=QUALIFICADORES_ALINE,
    ferramentas_titulo=FERRAMENTAS_TITULO_ALINE,
    qualificadores_cargo=QUALIFICADORES_CARGO_ALINE,
    cidades=CIDADES_ALINE,
    mercados_remoto_aceitos=MERCADOS_REMOTO_ACEITOS_ALINE,
    termos_bloqueados_titulo=TERMOS_BLOQUEADOS_TITULO_ALINE,
    modalidades_aceitas=MODALIDADES_ACEITAS_ALINE,
    niveis_senioridade_alvo=("Pleno", "Sênior", "Especialista", "Liderança"),
    niveis_senioridade_penalizados=("Júnior", "Estágio", "Trainee"),
)
...
_SCRAPERS_ALINE = [
    ...
    DefinicaoScraper(
        ...
        FREQUENCIA_ALTA,
        {
            "locations": LOCATIONS_LINKEDIN_ALINE,
            "locations_remoto_apenas": LOCATIONS_LINKEDIN_REMOTO_APENAS_ALINE,
            "locations_cidades_presencial": LOCATIONS_LINKEDIN_CIDADES_HIBRIDO_ALINE,
        },
    ),
...
PERFIL_ALINE = Perfil(
    chave="aline",
    nome="Aline — Brasil remoto / Curitiba híbrido",
    palavras_monitoradas=KEYWORDS_ALINE,
    paises_pesquisados=["Brasil"],
    regras=_REGRAS_ALINE,
    regras_eixo_secundario=None,
    eixo_secundario_ativo=False,
    eixo_secundario_rotulo="",
    termos_busca=TERMOS_BUSCA_ALINE,
    termos_por_ciclo=TERMOS_POR_CICLO_ALINE,
    termos_prioritarios=TERMOS_PRIORITARIOS_ALINE,
    definicao_scrapers=_SCRAPERS_ALINE,
    max_scrapers_concorrentes=4,
)
...
PERFIS = {
    ...
    PERFIL_ALINE.chave: PERFIL_ALINE,
}
